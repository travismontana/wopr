...
cam_options = [
    {"name": "c950", "endpoint": "http://wopr-cam:5101/snapshot"},
    {"name": "c960", "endpoint": "http://wopr-cam:5100/snapshot"},
    {"name": "rPi", "endpoint": "http://wopr-cam:5102/snapshot"},
]
...
if img:
    ...
    for num in range(15, 360, 30):
        ...
        inner_num = num // 30 + 12  # this should be 1 if 15, 2 if 45
        cv2.putText(
            img_rgb_u8,
            str(inner_num),
            (inner_x, inner_y),
