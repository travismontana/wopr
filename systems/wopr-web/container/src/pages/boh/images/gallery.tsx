    ...
    async function loadImages() {
        ...
        try {
            ...
            const galleryImages = data.map(img => {
                const imageUrl = `https://images.studio.abode.tailandtraillabs.org/ml/dune__imperium___uprising/${img.filename}`;
                const thumbnailUrl = `https://thumbor.studio.abode.tailandtraillabs.org/unsafe/300x0/ml/dune__imperium___uprising/${img.filename}`;
