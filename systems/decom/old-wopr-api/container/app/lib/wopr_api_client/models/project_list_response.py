...
if TYPE_CHECKING:
    from ..models.project_list_response_results_item import (
...
class ProjectListResponse:
    ...
    Attributes:
        count (int):
        results (list[ProjectListResponseResultsItem]):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ProjectListResponseResultsItem.from_dict(results_item_data)
