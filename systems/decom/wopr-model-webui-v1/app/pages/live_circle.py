...
ret_c950, otsu_c950 = cv2.threshold(
    gaus_c950, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU
)
ret_c960, otsu_c960 = cv2.threshold(
    gaus_c960, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU
)
...
lines_c950 = cv2.HoughLinesP(
    dila_c950, 1, np.pi / 180, 100, minLineLength=100, maxLineGap=10
)
lines_c960 = cv2.HoughLinesP(
    dila_c960, 1, np.pi / 180, 100, minLineLength=100, maxLineGap=10
)
